...
function PersonalInfo() {
    ...
    const handleRowClick = (record) => {
        navigate(`/chi-tiet-tin-dang/${record.key}`);
    };
    ...
    const favoriteColumns = [
        {
            ...
            render: (images) => (
                <img
                    src={images && images.length > 0 ? images[0] : userNotFound}
                    alt="Post thumbnail"
                    style={{ width: 80, height: 60, objectFit: 'cover', borderRadius: 4 }}
                    onError={(e) => {
                        e.target.src = userNotFound; // fallback to default user image
                    }}
                />
            ),
        },
        ...
        },
        {
            ...
            dataIndex: 'address',
            key: 'address',
            render: (address) => address?.fullAddress || address || 'N/A',
        },
        {
            title: 'Diện tích',
            dataIndex: 'area',
