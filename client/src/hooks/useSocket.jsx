...
export const useSocket = () => {
    ...
    useEffect(() => {
        ...
        socket.on('connect', () => {
            ...
            // Rejoin any relevant rooms after connection
            // This would be handled by the parent component when it knows the conversation context
        });
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                ...
                // Chỉ log lỗi, không throw để không làm crash app
