#!/usr/bin/env python3
"""
Enhanced Simple Chatbot with better response formatting and image support
"""
...
class EnhancedSimpleChatBot:
    ...
    def process_question(self, question: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Clean up the response to avoid duplicate content
            ...
            if show_rooms_prefix in clean_response:
                logger.info("Response contains room show instruction")
                return self._format_room_response(clean_response, relevant_docs)
            else:
    ...
    def _clean_response(self, response_text):
        """Clean up the response to remove duplicate sentences"""
...
if __name__ == "__main__":
    # Example usage
    print("Enhanced Simple ChatBot - Following the specified flow")
    print("="*50)
    ...
    # Initialize chatbot
    chatbot = EnhancedSimpleChatBot(vector_store)
    chatbot.init_chatbot()
    
    # Example question
    question = "toi muon tim phong o thanh xuan ha noi"
    ...
    if response['rooms']:
        ...
        for i, room in enumerate(response['rooms'][:3]):
            ...
            print(f"     Images: {room.get('images', [])}")
    else:
